...
<div className='left'>
    ...
    <p>Check out our featured product of the day (subject to change on page refresh). We would appreciate it very much if you bought one or more of this item, today. Thanks so much in advance!</p>
 <Link to="/Products" className='Navbar-link'>
<button className='default-button'>See all products</button> </Link>
