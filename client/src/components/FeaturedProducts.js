...
<div className='left'>
    ...
    <p>On the right, check out our featured product of the day (subject to change on page refresh). We would appreciate it very much if you bought one or more of this item, today. Thanks so much in advance!</p>
 <Link to="/Products" className='Navbar-link'>
<button className='default-button'><h3>See all products</h3></button> </Link>
   
</div>
<div className='right'>
<Link to={`/${featuredProduct.id}/productdetailspage`}><img src={featuredProduct.medImageUrl}/> </Link>
